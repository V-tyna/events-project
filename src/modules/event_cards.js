        ...
        <div class="card">
                <img
                    ...
                    <div class="card-body">
                        ...
                        <a href="#" id="${obj.id}" class="blue-button btn btn-primary">${obj.btn}</a>
            ...
            <div class="modal-overlay">
                <div class="modal-window" style="width: 450px">
                    <div class="modal-header">
                        ...
                        <button ${!arrayOfObjects.closeable ? 'disabled' : ''} class="modal-close">&times;</button>
                    </div>
                    <div class="modal-body"> Data of activity: ${arrayOfObjects.data}
    ...
    window.innerHTML = `<div class="modal-overlay">
                <div class="modal-window" style="width: 450px">
                    ...
                    <div class="modal-footer">
                        ...
                        <button id="${arrayOfObjects.delete}" class="delete-data btn btn-danger">Delete</button>
                    </div>
                </div>`
    document.body.appendChild(window);
    return window;
...
const containerRows = document.querySelector('.row');
let eventCardModalWindow;
containerRows.addEventListener('click', (event) => {
    event.preventDefault();

    if (event.target.className.includes('blue-button')) {
